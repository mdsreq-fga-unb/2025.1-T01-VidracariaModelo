...
|**RF02**|Visualizar serviços agendados|O sistema deve listar os agendamentos realizados para os administradores visualizarem os compromissos do dia.|**RN** **01**, **07**, **08**, **09**, **10**, **11**, **12**, **13**, **29**|Objetivo 2: Otimizar gestão de orçamentos e agendamentos.|
|**RF03**|Remarcar agendamento|O sistema deve permitir a remarcação de agendamentos para programar compromissos com clientes.|**RN** **14**, **15**, **16**, **17**, **18**, **19**, **20**, **21**, **22**|Objetivo 2: Otimizar gestão de orçamentos e agendamentos.|
|**RF04**|Cancelar agendamento|O sistema deve permitir o cancelamento dos agendamentos para ajustes na agenda de compromissos.|**RN** **23**, **24**, **25**, **26**, **27**, **28**, **103**|Objetivo 2: Otimizar gestão de orçamentos e agendamentos.|
|**RF05**|Criar orçamento|O sistema deve permitir a criação de orçamentos para registrar propostas de serviços no site.|**RN** **30**, **31**, **32**, **33**, **34**, **35**, **36**, **73** |Objetivo 2: Otimizar gestão de orçamentos e agendamentos.|
...
|**RF07**|Editar orçamentos|O sistema deve permitir edição de valores, prazos e observações para atualizar os dados do orçamento conforme necessário.|**RN** **43**, **44**, **45**, **46**, **47** |Objetivo 2: Otimizar gestão de orçamentos e agendamentos.|
|**RF08**|Criar Venda|O sistema deve permitir o registro de uma venda.|**RN** **48**, **55**, **56**, **73** |Objetivo 4: Aprimorar gestão financeira e de vendas.|
|**RF09**|Listar vendas|O sistema deve apresentar a lista de vendas feitas pela empresa para controle comercial.|**RN** **48**, **49**, **50**, **51**, **52** |Objetivo 4: Aprimorar gestão financeira e de vendas.|
...
|**RF11**|Editar venda|O sistema deve permitir edição dos detalhes da venda para correção de dados.|**RN** **49**, **59**, **60**, **61** |Objetivo 4: Aprimorar gestão financeira e de vendas.|
...
|**RF20**|Cadastrar perguntas frequentes na FAQ|O sistema deve permitir que os administradores adicionem as perguntas frequentes na área de FAQ para auxiliar o cliente.|**RN** **93**, **94**, **95**|Objetivo 1: Sofisticar o marketing e proporcionando posicionamento online. |
|**RF21**|Excluir Avaliação|O sistema deve permitir a exclusão de avaliações realizadas pelo cliente para manter a integridade das informações publicadas.|**RN** **96**, **97** |Objetivo 1: Sofisticar o marketing e proporcionando posicionamento online.|
|**RF22**|Publicar avaliação|O sistema deve permitir que o usuário publique uma avaliação com nota e comentário para registrar sua opinião sobre os serviços.|**RN** **99**, **105**, **106** |Objetivo 1: Sofisticar o marketing e proporcionando posicionamento online.|
|**RF23**|Criar perfil do cliente|O sistema deve permitir a criação de perfis de cliente para armazenar seus dados e histórico de interações.|**RN** **73**, **98**, **101** |Objetivo 4: Aprimorar gestão financeira e de vendas.|
...
|**RF25**|Excluir perfil do cliente|O sistema deve permitir a exclusão das informações do perfil do cliente para atender solicitações de privacidade.|**RN** **73**, **107**|Objetivo 4: Aprimorar gestão financeira e de vendas.|
