...
| **RF26**   | Gerar gráfico de desempenho      | Gráfico com métricas de atendimento e conversão                          | 18, 81                                    | 3-Viabilizar gestão de demandas                          | C      | 1    |     |
| **RF27**   | Gráfico comparativo financeiro   | Receita vs Despesas por mês                                              | 18, 58                                | 4-Aprimorar gestão financeira e de vendas                | C      | 1    | X   |
